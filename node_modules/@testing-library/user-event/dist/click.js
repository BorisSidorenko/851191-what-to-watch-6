...
function click(element, init, {
  ...
  if ((0, _utils.isInstanceOfElement)(element, 'HTMLLabelElement')) {
    clickLabel(element, init, {
      clickCount
    });
  } else if ((0, _utils.isInstanceOfElement)(element, 'HTMLInputElement')) {
    const el = element;

    if (el.type === 'checkbox' || el.type === 'radio') {
      clickBooleanElement(el, init, {
        clickCount
      });
    } else {
      clickElement(el, init, {
        clickCount
      });
    }
  } else {
